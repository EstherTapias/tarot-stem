...
// under other top-level constants
...
export const CardReading: React.FC = () => {
  ...
  const [gamePhase, setGamePhase] = useState<
    "intro" | "dealing" | "selecting" | "complete"
  >("intro");
  ...
  /* ──────────────────────────────────────────────────────────────────────────
     ADDED: keep local readingState in sync with lifted Outlet context
  ─────────────────────────────────────────────────────────────────────────── */
  // useEffect(() => {
  //   setReadingState((prev) => ({
  //     ...prev,
  //     selectedCards: selectedCards as any, // matches ReadingState shape
  //     isComplete,
  //   }));
  // }, [selectedCards, isComplete]);
  useEffect(() => {
    // Mirror lifted selection into local readingState
    setReadingState((prev) => {
      ...
      const nextCurrent =
        len >= 3
          ? null
          : POSITIONS.find(
              (p) => !selectedCards.map((sc) => sc.position).includes(p)
            ) ?? "past";
      ...
      return {
        ...
        isComplete,
        currentPosition: nextCurrent as any,
        // keep availableCards as-is; it’s unrelated to persistence
      };
    });

    // Set the right game phase so UI un-gates when coming back
  ...
  const handleCardSelection = (card: TarotCard): void => {
    setReadingState((prev) => {
      ...
      const nextPosForNewCard =
        positions.find((pos) => !selectedPositions.includes(pos)) ?? null;

      // Asignamos esta posición a la nueva carta
      newSelectedCards[newSelectedCards.length - 1] = {
        position: nextPosForNewCard!,
        card,
      };
      ...
      const nextCurrentPosition = isComplete
        ? null
        : positions.find(
            (pos) => !newSelectedCards.map((sc) => sc.position).includes(pos)
          ) ?? null;

      /* ──────────────────────────────────────────────────────────────────────
         ADDED: also update lifted Outlet context so it persists across routes
      ─────────────────────────────────────────────────────────────────────── */
  ...
  const handleResetReading = (): void => {
    ...
    /* ───────────────────────────────────────────────────────────────────────
       ADDED: also reset lifted Outlet context
    ──────────────────────────────────────────────────────────────────────── */
    setSelectedCards([]);
    setIsComplete(false);
    /* ─────────────────────────────────────────────────────────────────────── */
  ...
  const renderIntroduction = () => (
    <div
      className="reading-intro mystical-carpet"
      style={{
        textAlign: "center",
    ...
    >
      ...
      >
        ...
        >
          <div
            className="step mystical-container"
          ...
          >
            ...
            <p className="mystical-text">
              Las cartas saldrán del mazo hacia el centro
            </p>
          </div>
          <div
            className="step mystical-container"
          ...
          >
            ...
            <p className="mystical-text">
              Selecciona 3 cartas que te llamen la atención
            </p>
          </div>
          <div
            className="step mystical-container"
          ...
          >
            ...
            <p className="mystical-text">
              Descubre tu Pasado, Presente y Futuro
            </p>
          </div>
        </div>
        <button
  ...
  const renderDeck = () => {
    ...
    return (
      ...
      >
        <div
          className="deck-info mystical-container"
          style={{
        ...
        >
          <div
            className="deck-counter mystical-text"
            style={{
            ...
            {bottomRow.map((card, index) => (
              <div
                ...
                style={{
                  ...
                  transition: "var(--transition)",
                  position: "relative",
                  animation: `slideFromDeck 0.8s ease-out ${
                    (index + 5) * 0.2
                  }s both`,
                }}
                onClick={() => handleCardSelection(card)}
    ...
    return (
      ...
      >
        {["past", "present", "future"].map((position) => {
          // const selectedCard = readingState.selectedCards.find(
          ...
          return (
            ...
            >
              <div
                className="position-label mystical-text"
                style={{
                  fontFamily: "var(--font-heading)",
                  fontSize: "1.2rem",
                  fontWeight: "600",
              ...
              <div
                className={`card-slot ${selectedCard ? "filled" : "empty"}`}
                style={{
                  width: "120px",
                  height: "180px",
                  border: selectedCard
                    ? "2px solid var(--gold-mystical)"
                    : "2px dashed var(--gold-mystical)",
                  borderRadius: "12px",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
              ...
              >
                {selectedCard ? (
                  <div
                    ...
                    onClick={() =>
                      navigate(`/card/${selectedCard.card.id}`, {
                        state: { from: "/reading" },
                      })
                    }
                    style={{
                  ...
                  <div
                    ...
                    style={{
                      ...
                      color: "var(--gold-mystical)",
                      opacity:
                        position === readingState.currentPosition ? 1 : 0.5,
                    }}
                  >
                    <div
      ...
      >
        ...
        >
          ...
          <div className="modal-content">
            ...
            >
              {selectedCards.map((selectedCard) => (
                <div
                  ...
                  className="summary-card mystical-container"
                  style={{
                    width: "240px",
                    minHeight: "340px",
                    display: "flex",
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div
                        className="summary-scientist mystical-text"
                        style={{
                          color: "var(--gold-mystical)",
                          fontSize: "0.9rem",
                        }}
            ...
            <div
              className="quick-interpretation mystical-carpet"
              style={{
      ...
      <div className="card-reading-page">
        <div className="mystical-container">
          ...
          >
            ...
            <p className="mystical-text">
              Preparando las cartas del destino...
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div
      className="card-reading-page fade-in"
          ...
          <>
            ...
            >
              ...
              >
                ...
                <div
                  className={`step ${
                    gamePhase === "selecting" || gamePhase === "complete"
                      ? "completed"
                      : ""
                  }`}
                  style={{
              ...
              >
                <div
                  ...
                  style={{
                    height: "100%",
                    background:
                      "linear-gradient(90deg, var(--gold-mystical), var(--gold-copper))",
                    borderRadius: "2px",
            ...
            {gamePhase === "dealing" && (
              <div
                className="dealing-status mystical-container"
                style={{
                  textAlign: "center",
                  padding: "var(--space-xl)",
                  maxWidth: "400px",
